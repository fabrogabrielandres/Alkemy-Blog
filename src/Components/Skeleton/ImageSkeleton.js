...
export const ImageSkeleton = ({ speed, width, height, viewBox, backgroundColor, foregroundColor }) => {
  ...
  return (
    <ContentLoader
      speed={speed ? speed : ImageDefult.speed}
      width={width ? width : ImageDefult.width}
      height={height ? height : ImageDefult.height}
      viewBox={viewBox ? viewBox : ImageDefult.viewBox}
      backgroundColor={backgroundColor ? backgroundColor : ImageDefult.backgroundColor}
      foregroundColor={foregroundColor ? foregroundColor : ImageDefult.foregroundColor}
    >
